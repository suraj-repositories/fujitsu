...
var options = {
    ...
    plotOptions: {
        candlestick: {
            colors: {
                upward: "rgb(12, 199, 99)",
                downward: "rgb(255, 56, 60)",
            },
        },
    },
    title: {
...
var options = {
    ...
    colors: ["rgba(var(--primary-rgb))", "rgb(255, 90, 41)", "rgb(12, 199, 99)", "rgb(12, 156, 252)"],
};
...
var spark6 = new ApexCharts(document.querySelector("#xrp-marketcap"), spark6);
spark6.render();
/* binance marketcap */
